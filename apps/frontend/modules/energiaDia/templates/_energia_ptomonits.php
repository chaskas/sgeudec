...
<form method="post" <?php $ptomonits->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    ...
    <?php echo $ptomonits['ptomonit']->Render(array('onchange'=>jq_remote_function(array('update' => 'grafico','url' => 'energiaDia/graficoPtomonit','with'     => " 'ptomonit_id=' +this.value")),'class'=>'text-input large-input2')); ?>
    </label>
