...
<form method="post" <?php $fecha->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    <label style="float:left;">Inicio<span style="color:red;font-weight: normal;">(*)</span><br/>
        <?php echo $fecha['fechaIni']->Render(array('onchange' => jq_remote_function(array('update' => 'grafico', 'url' => 'energiaPeriodo/graficoFecha', 'with' => " 'fechaIni=' +this.value")), 'class' => 'text-input','style'=>'width:80px')); ?>
    </label>
    <label style="float:left;">Fin <span style="color:red;font-weight: normal;">(*)</span><br/>
        <?php echo $fecha['fechaFin']->Render(array('onchange' => jq_remote_function(array('update' => 'grafico', 'url' => 'energiaPeriodo/graficoFecha', 'with' => " 'fechaFin=' +this.value")), 'class' => 'text-input','style'=>'width:80px')); ?>
    </label>
