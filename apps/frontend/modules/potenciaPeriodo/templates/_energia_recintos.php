...
<form method="post" <?php $recintos->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    ...
    <?php echo $recintos['recinto']->Render(array('onchange'=>jq_remote_function(array('update' => 'ptomonits','url' => 'potenciaPeriodo/ptomonit','with'     => " 'recinto_id=' +this.value")),'class'=>'text-input large-input2')); ?>
    </label>
