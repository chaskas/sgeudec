...
<form method="post" <?php $sensores->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    ...
    <?php echo $sensores['sensor']->Render(array('onchange'=>jq_remote_function(array('update' => 'grafico','url' => 'potenciaPeriodo/grafico','with'     => " 'sensor_id=' +this.value")),'class'=>'text-input large-input2')); ?>
    </label>
